        ...
        // If it's an object, check for common array properties
          ...
          if (Array.isArray(obj.data)) {
            ...
            if (Object.keys(obj).length === 0) {
              ...
              console.error('API response does not contain a blog array:', responseData);
              setError('Invalid data format: response contains data but no blog array');
              setBlogList([]);
            }
          }
        } else {
    ...
    <div className="container mx-auto p-4">
      <div className="mb-6">
        ...
        <Button onClick={() => window.location.href = '/'}
          className='curospos-pointer me-2'
        >
          Home
        </Button>
